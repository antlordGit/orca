...
import type { AgentPromptShortcuts } from './agent-prompt-shortcuts'
import type {
  AgentDashboardMode,
...
export type GlobalSettings = {
  ...
  /** Saved one-click prompts for the Native Chat composer, keyed by agent. */
  agentPromptShortcuts?: AgentPromptShortcuts
